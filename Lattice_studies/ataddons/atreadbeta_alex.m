function [superp,periods]=atreadbeta_alex(filename,cavipass,bendpass,quadpass)
...
case 'DI'
   ...
   newelem=atelem('rbend2','FamName',elname,'Length',params(1)*params(2),'BendingAngle',params(1),...
   'K',strength,'PolynomA',[0 0 0],'PolynomB',[0 strength 0],'FringeInt1',0.,'FringeInt2',0., ...
