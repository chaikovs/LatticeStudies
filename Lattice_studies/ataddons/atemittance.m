function [Emittance, EnergySpread, Jx] = atemittance(THERING,beta, alpha, disp)
...
% 
Jx = 1 - sum.integrals(4)/sum.integrals(2);
Emittance = 3.8319e-13*(sum.e0*1e3/0.510999).^2*sum.integrals(5)/(Jx*sum.integrals(2));
