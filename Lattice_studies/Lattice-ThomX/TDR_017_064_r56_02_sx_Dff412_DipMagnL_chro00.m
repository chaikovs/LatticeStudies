function varargout = TDR_017_064_r56_02_sx_Dff412_DipMagnL_chro00
%************************************************************
...
% disp(['** Loading THOMX ring lattice ', mfilename]);
 ...
 L0 =  17.986715999999991; %17.986704000000003; % design circumference length [m]; 
...
QP1 = quadrupole('QP1', LQP, -.5197395E+01, QPassMethod);
QP2 = quadrupole('QP2', LQP, 0.9962261E+01, QPassMethod);
QP3 = quadrupole('QP3', LQP, -.1791292E+02, QPassMethod);
QP4 = quadrupole('QP4', LQP, 0.1614904E+02, QPassMethod);
QP31 = quadrupole('QP31', LQP, -.1033062E+02, QPassMethod);
QP41 = quadrupole('QP41', LQP, 0.6888317E+01, QPassMethod);
