function ring=thomx_at2_BPM()
ring={...
       atmarker('DEBUT');...
       atmarker('SEPT');...
        atdrift('SD5B',0.74,'Energy',50000000);...
      atmonitor('BPM','Name','BPM','Energy',50000000);...
   ...
   atquadrupole('QP2',0.15,9.962261,'StrMPoleSymplectic4Pass','Energy',50000000);...
        ...
        atdrift('SD3S2',0.0851135,'Energy',50000000);...
    atsextupole('SX1',0.06,-106.928783333333,'Energy',50000000);...
    atcorrector('HCOR',1e-06,[0 0],'StrMPoleSymplectic4Pass','PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
    atcorrector('VCOR',1e-06,[0 0],'StrMPoleSymplectic4Pass','PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
        atdrift('SD3S',0.045,'Energy',50000000);...
   atquadrupole('QP31',0.15,-10.33062,'StrMPoleSymplectic4Pass','Energy',50000000);...
        atdrift('SD3S',0.045,'Energy',50000000);...
    atsextupole('SX3',0.06,-54.8257833333333,'Energy',50000000);...
    atcorrector('HCOR',1e-06,[0 0],'StrMPoleSymplectic4Pass','PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
    atcorrector('VCOR',1e-06,[0 0],'StrMPoleSymplectic4Pass','PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
        atdrift('SD3S1',0.105,'Energy',50000000);...
   atquadrupole('QP41',0.15,6.888317,'StrMPoleSymplectic4Pass','Energy',50000000);...
        atdrift('SD1S1B',0.06,'Energy',50000000);...
      atmonitor('BPM','Name','BPM','Energy',50000000);...
        atdrift('SD1S1',0.16,'Energy',50000000);...
    atsextupole('SX2',0.06,40.7643333333333,'Energy',50000000);...
    atcorrector('HCOR',1e-06,[0 0],'StrMPoleSymplectic4Pass','PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
    atcorrector('VCOR',1e-06,[0 0],'StrMPoleSymplectic4Pass','PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
        atdrift('SD1S',0.045,'Energy',50000000);...
