...
dx=10e-6*randn(size(indq)); % random errors of 10um
dy=10e-6*randn(size(indq)); % random errors of 10um
dt=10e-6*randn(size(indq)); % random errors of 10urad
...
figure('units','normalized','position',[0.1 0.4 0.65 0.35])
atplot(ringerr,[0,20],'comment',[],@plClosedOrbit);
