...
ring={...
   ...
   atquadrupole('QP2',0.15,9.962261,'StrMPoleSymplectic4Pass','Energy',50000000);...
    ...
    atsextupole('SX1',1e-06,-6415727,'Energy',50000000);...
        atrbend('HCOR',1e-06,0,0,'BndMPoleSymplectic4Pass','FringeBendEntrance',0,'FringeBendExit',0,'FringeQuadEntrance',0,'FringeQuadExit',0,'FullGap',0,'FringeInt1',0.5,'FringeInt2',0.5,'Energy',50000000);...
        atrbend('VCOR',1e-06,0,0,'BndMPoleSymplectic4Pass','FringeBendEntrance',0,'FringeBendExit',0,'FringeQuadEntrance',0,'FringeQuadExit',0,'FullGap',0,'FringeInt1',0.5,'FringeInt2',0.5,'Energy',50000000);...
