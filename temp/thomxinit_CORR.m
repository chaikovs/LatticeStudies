...
%AO.(ifam).Setpoint.DeltaRespMat(:,:) = ones(devnumber,1)*5e-5*2; % ??? urad (half used for kicking) 
 AO.(ifam).Setpoint.DeltaRespMat(:,:) = ones(devnumber,1)*5e-6*2; % 2*5 urad (half used for kicking) % LAST
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% TEMPORARY HORIZONTAL CORRECTORS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ifam = 'HCORT';
AO.(ifam).FamilyName               = ifam;
AO.(ifam).FamilyType               = 'COR';
AO.(ifam).MemberOf                 = {'MachineConfig'; 'HCORT'; 'COR'; 'Magnet'; 'PlotFamily'; 'Archivable'};
...
% the current range needed to be update for ThomX in the future
varlist = {
     1  [ 1 1] 'RI-C1/ME/STRT.010      ' 1 'HCORT001' 'current   ' 'currentPM ' [-11.0  11.0]
     2  [ 1 2] 'RI-C1/ME/STRT.020      ' 1 'HCORT002' 'current   ' 'currentPM ' [-11.0  11.0]
     3  [ 1 3] 'RI-C1/ME/STRT.030      ' 1 'HCORT003' 'current   ' 'currentPM ' [-11.0  11.0]
     4  [ 1 4] 'RI-C1/ME/STRT.040      ' 1 'HCORT004' 'current   ' 'currentPM ' [-11.0  11.0]
%      5  [ 1 5] 'RI-C1/ME/STRT.050      ' 1 'HCORT005' 'current   ' 'currentPM ' [-11.0  11.0]
%      6  [ 1 6] 'RI-C1/ME/STRT.060      ' 1 'HCORT006' 'current   ' 'currentPM ' [-11.0  11.0]
%      7  [ 1 7] 'RI-C1/ME/STRT.070      ' 1 'HCORT007' 'current   ' 'currentPM ' [-11.0  11.0]
%      8  [ 1 8] 'RI-C1/ME/STRT.080      ' 1 'HCORT008' 'current   ' 'currentPM ' [-11.0  11.0]
     
     5  [ 2 1] 'RI-C2/ME/STRT.010      ' 1 'HCORT005' 'current   ' 'currentPM ' [-11.0  11.0]
     6  [ 2 2] 'RI-C2/ME/STRT.020      ' 1 'HCORT006' 'current   ' 'currentPM ' [-11.0  11.0]
     7  [ 2 3] 'RI-C2/ME/STRT.030      ' 1 'HCORT007' 'current   ' 'currentPM ' [-11.0  11.0]
     8  [ 2 4] 'RI-C2/ME/STRT.040      ' 1 'HCORT008' 'current   ' 'currentPM ' [-11.0  11.0]
%      5  [ 2 5] 'RI-C2/ME/STRT.050      ' 1 'HCORT013' 'current   ' 'currentPM ' [-11.0  11.0]
%      6  [ 2 6] 'RI-C2/ME/STRT.060      ' 1 'HCORT014' 'current   ' 'currentPM ' [-11.0  11.0]
%      7  [ 2 7] 'RI-C2/ME/STRT.070      ' 1 'HCORT015' 'current   ' 'currentPM ' [-11.0  11.0]
%      8  [ 2 8] 'RI-C2/ME/STRT.080      ' 1 'HCORT016' 'current   ' 'currentPM ' [-11.0  11.0]
...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% TEMPORARY VERTICAL CORRECTORS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ifam = 'VCORT';
AO.(ifam).FamilyName               = ifam;
AO.(ifam).FamilyType               = 'COR';
AO.(ifam).MemberOf                 = {'MachineConfig'; 'VCORT'; 'COR'; 'Magnet'; 'PlotFamily'; 'Archivable'};
...
varlist = {
     1  [ 1 1] 'RI-C1/ME/STR.010      ' 1 'VCORT001' 'current   ' 'currentPM ' [-11.0  11.0]
     2  [ 1 2] 'RI-C1/ME/STR.020      ' 1 'VCORT002' 'current   ' 'currentPM ' [-11.0  11.0]
     3  [ 1 3] 'RI-C1/ME/STR.030      ' 1 'VCORT003' 'current   ' 'currentPM ' [-11.0  11.0]
     4  [ 1 4] 'RI-C1/ME/STR.040      ' 1 'VCORT004' 'current   ' 'currentPM ' [-11.0  11.0]
%      5  [ 1 5] 'RI-C1/ME/STR.050      ' 1 'VCORT005' 'current   ' 'currentPM ' [-11.0  11.0]
%      6  [ 1 6] 'RI-C1/ME/STR.060      ' 1 'VCORT006' 'current   ' 'currentPM ' [-11.0  11.0]
%      7  [ 1 7] 'RI-C1/ME/STR.070      ' 1 'VCORT007' 'current   ' 'currentPM ' [-11.0  11.0]
%      8  [ 1 8] 'RI-C1/ME/STR.080      ' 1 'VCORT008' 'current   ' 'currentPM ' [-11.0  11.0]
     
     5  [ 2 1] 'RI-C2/ME/STR.010      ' 1 'VCORT005' 'current   ' 'currentPM ' [-11.0  11.0]
     6  [ 2 2] 'RI-C2/ME/STR.020      ' 1 'VCORT006' 'current   ' 'currentPM ' [-11.0  11.0]
     7  [ 2 3] 'RI-C2/ME/STR.030      ' 1 'VCORT007' 'current   ' 'currentPM ' [-11.0  11.0]
     8  [ 2 4] 'RI-C2/ME/STR.040      ' 1 'VCORT008' 'current   ' 'currentPM ' [-11.0  11.0]
%      5  [ 2 5] 'RI-C2/ME/STR.050      ' 1 'VCORT013' 'current   ' 'currentPM ' [-11.0  11.0]
%      6  [ 2 6] 'RI-C2/ME/STR.060      ' 1 'VCORT014' 'current   ' 'currentPM ' [-11.0  11.0]
%      7  [ 2 7] 'RI-C2/ME/STR.070      ' 1 'VCORT015' 'current   ' 'currentPM ' [-11.0  11.0]
%      8  [ 2 8] 'RI-C2/ME/STR.080      ' 1 'VCORT016' 'current   ' 'currentPM ' [-11.0  11.0]
...
%AO.(ifam).Setpoint.DeltaRespMat(:,:) = ones(devnumber,1)*10e-5*2;
 AO.(ifam).Setpoint.DeltaRespMat(:,:) = ones(devnumber,1)*10e-6*2;
...
setfamilydata_local('HCORT');
setfamilydata_local('VCORT');
