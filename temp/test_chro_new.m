...
%%
ring_NEW = thomx_FFgood();
ring = thomx_FFver1();
ring_NEW_wo_FF = thomx_WOFFver0();

ring_linear=atsetfieldvalues(ring,findcells(ring,'PassMethod','BndMPoleSymplecticPass'),...
...
subplot 211
set(gca,'FontSize',18)
plot(dp_NEW,tuneDPx_NEW - t0(1) ,'b.-','MarkerSize',9 ,'DisplayName', 'AT (BndMPoleSymplectic4Pass ver 3)')
hold on
plot(dp,tuneDPx - t0(1) ,'gs-','MarkerSize',4 ,'DisplayName', 'AT (BndMPoleSymplectic4Pass ver 1)')
%plot(data_analdip_nux(:,1),data_analdip_nux(:,2) - t0(1) ,'kd-','MarkerSize',4,'DisplayName', 'BETA (analytical dipole)')
plot(data_dip_nux(:,1),data_dip_nux(:,2) - t0(1) ,'kd-','MarkerSize',4,'DisplayName', 'BETA (fringing field)' )
...
subplot 212
set(gca,'FontSize',18)
plot(dp_NEW,tuneDPz_NEW -t0(2) ,'b.-','MarkerSize',9,'DisplayName', 'AT (BndMPoleSymplectic4Pass ver 3)' )
hold on
plot(dp,tuneDPz -t0(2) ,'gs-','MarkerSize',4,'DisplayName', 'AT (BndMPoleSymplectic4Pass ver 1)' )
%plot(data_analdip_nuz(:,1),data_analdip_nuz(:,2) - t0(2) ,'kd-','MarkerSize',4,'DisplayName', 'BETA (analytical dipole)' )
plot(data_dip_nuz(:,1),data_dip_nuz(:,2) - t0(2) ,'kd-','MarkerSize',4 ,'DisplayName', 'BETA (fringing field)')
...
print('thomx_tunediff_dpp_FF_new.png','-dpng','-r300')
...
subplot 211
set(gca,'FontSize',18)
plot(dp_NEW,tuneDPx_NEW - t0(1) ,'b.-','MarkerSize',9 ,'DisplayName', 'AT with FF (BndMPoleSymplectic4Pass ver 3)')
hold on
plot(dp_NEW_wo_FF,tuneDPx_NEW_wo_FF - t0(1) ,'g.-','MarkerSize',9 ,'DisplayName', 'AT wo FF (BndMPoleSymplectic4Pass ver 0)')
...
subplot 212
set(gca,'FontSize',18)
plot(dp_NEW,tuneDPz_NEW -t0(2) ,'b.-','MarkerSize',9,'DisplayName', 'AT with FF (BndMPoleSymplectic4Pass ver 3)' )
hold on
plot(dp_NEW_wo_FF,tuneDPz_NEW_wo_FF - t0(2) ,'g.-','MarkerSize',9 ,'DisplayName', 'AT wo FF (BndMPoleSymplectic4Pass ver 0)')
...
print('thomx_tunediff_dpp_new.png','-dpng','-r300')
