...
%% Third panel
% plot courant
temp=tango_read_attribute2('BOO-C01/DG/DCCT','integrationTime');
tmax=temp.value(1);
temp=tango_read_attribute2('BOO-C01/DG/DCCT','numSamples');
np=temp.value(1);
tt=(1:np)*tmax/np;
...
if hplot5 == 0
     ...
     hplot5 = stairs(handles.DCCT,tt,cur,'r');
...
set(handles.DCCT,'YLim',[-10 0.1]);
set(handles.DCCT,'XLim',[0 tmax]);
