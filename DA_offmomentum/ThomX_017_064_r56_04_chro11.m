function ring=ThomX_017_064_r56_04_chro11()
ring={...
       atmarker('DEBUT');...
       atmarker('SEPT');...
   ...
   atquadrupole('QP1',0.15731,-4.257891,'QuadMPoleFringePass','Energy',50000000);...
        atdrift('SD2',0.20269,'Energy',50000000);...
   atquadrupole('QP2',0.15731,8.658917,'QuadMPoleFringePass','Energy',50000000);...
    ...
    atsextupole('SX1',1e-06,1953408.6,'Energy',50000000);...
   ...
   atquadrupole('QP31',0.15731,-9.864231,'QuadMPoleFringePass','Energy',50000000);...
        atdrift('SD3S',0.071345,'Energy',50000000);...
    atsextupole('SX3',1e-06,-7709460.02652047,'Energy',50000000);...
    atcorrector('HCOR',1e-06,[0 0],'PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
    atcorrector('VCOR',1e-06,[0 0],'PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
        atdrift('SD3S1',0.131345,'Energy',50000000);...
   atquadrupole('QP41',0.15731,3.472987,'QuadMPoleFringePass','Energy',50000000);...
        atdrift('SD1S1B',0.056345,'Energy',50000000);...
       atmarker('BPMx');...
       atmarker('BPMz');...
        atdrift('SD1S1',0.19,'Energy',50000000);...
    atsextupole('SX2',1e-06,3079704.53729431,'Energy',50000000);...
    atcorrector('HCOR',1e-06,[0 0],'PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
    atcorrector('VCOR',1e-06,[0 0],'PolynomA',0,'PolynomB',0,'NumIntSteps',1,'MaxOrder',1,'Energy',50000000);...
        atdrift('SD1S',0.071345,'Energy',50000000);...
   atquadrupole('QP4',0.15731,16.47542,'QuadMPoleFringePass','Energy',50000000);...
        atdrift('SD2',0.20269,'Energy',50000000);...
   atquadrupole('QP3',0.15731,-14.33512,'QuadMPoleFringePass','Energy',50000000);...
